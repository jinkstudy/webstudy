...
<%
	...
	String price_value = request.getParameter("price");
	price = Integer.parseInt(price_value);
	...
	//Object goods_id = session.getAttribute("id");
	//Object goods_name = session.getAttribute("name");
	//Object goods_price = session.getAttribute("price");
	...
	// 	Goods list= new Goods(id,name,price);
	// 	glist.add(list);
