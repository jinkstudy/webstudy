...
<head>
	...
	<script>
		...
		window.onload=function(){
			...
			xmlHttp.open("GET","01_server.jsp?"+data,true); //비동기 통신하려면 true
			// 5. 실제 데이터 전송.
			xmlHttp.send(null); //get 방식은 url에 보낼 데이터를 이미 셋팅했기때문에 추가적으로 보낼 데이터가 없음.null
